package net.lizistired.betterwax.data.items;
...
public class WaxBucket extends Item implements FluidModificationItem {
    private final Fluid fluid;

    public WaxBucket(Fluid fluid, Item.Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
    @Override
